export const queryTab = () => chrome.tabs.query({ url: "*://chat.mistral.ai/*" , currentWindow:true})

export const createTab = () => chrome.tabs.create({ url: "https://chat.mistral.ai/chat", pinned: true })
