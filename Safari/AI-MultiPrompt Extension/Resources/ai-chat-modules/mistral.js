export const queryTab = () => browser.tabs.query({ url: "*://chat.mistral.ai/*" , currentWindow:true})

export const createTab = () => browser.tabs.create({ url: "https://chat.mistral.ai/chat", pinned: true })
