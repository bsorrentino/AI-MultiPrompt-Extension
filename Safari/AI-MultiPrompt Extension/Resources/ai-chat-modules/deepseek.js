export const queryTab = () => browser.tabs.query({ url: "*://chat.deepseek.com/*" , currentWindow:true})

export const createTab = () => browser.tabs.create({ url: "https://chat.deepseek.com/", pinned: true })
