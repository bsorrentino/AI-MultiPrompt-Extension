...
export const _LL = (msg) => browser.runtime.sendMessage({ log: msg })
...
export class AIToggle extends HTMLElement {
    ...
    async queryTab() {
        ...
        return browser.tabs.query({ url: this.queryTabUrl , currentWindow:true});
    }
    ...
    createTab() {
        ...
        return browser.tabs.create({ url: this.createTabUrl, pinned: true })
    }
